...
- hackathon branch native overrides: `TATUM_NATIVE_CONTRACT_ADDRESS_BASE`, `TATUM_NATIVE_CONTRACT_ADDRESS_OPTIMISM`, `TATUM_NATIVE_CONTRACT_ADDRESS_ARBITRUM`, `TATUM_NATIVE_CONTRACT_ADDRESS_AVALANCHE`, `TATUM_NATIVE_CONTRACT_ADDRESS_FANTOM`, `TATUM_NATIVE_CONTRACT_ADDRESS_ETH_SEPOLIA`
